...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    gridTl
      .from('.suc', { y: 100, opacity: 0, stagger: 0.3 })
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-screen flex justify-center items-center" id="features">
      <div ref={divRef} className="w-full relative border-8 rounded-3xl border-[hsl(0,0%,19%)]">
        <div className="absolute bottom-full mb-5 text-5xl font-bold">
          Features
        </div>
        <div className="grid grid-cols-3 grid-rows-2 h-[80vh] p-4 gap-4">
          <div className="suc">
            <div className="group h-full border-8 rounded-3xl border-[hsl(0,0%,19%)] flex flex-col items-center p-1 
           hover:scale-102 hover:cursor-pointer transition-all duration-100 ease-in">
              <div className="flex flex-col items-center justify-center flex-1">
                <LockClosedIcon className="h-16 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.7)] 
          ...
          <div className="suc row-span-2">
            <div className="group h-full border-8 rounded-3xl border-[hsl(0,0%,19%)] flex flex-col
                            hover:scale-102 hover:cursor-pointer transition-all duration-100 ease-in">
              ...
              <div className="flex-1 flex flex-col items-center p-1">
                <div className="flex flex-col items-center justify-center flex-1">
                  <SparklesIcon className="h-16 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.7)] 
                transition-all duration-100 ease-in" />
                </div>
                <div className="w-3/4 flex-1 gap-2 flex flex-col">
                  <h1 className="text-2xl font-bold self-center">
          ...
          <div className="suc">
            <div className="group h-full border-8 rounded-3xl border-[hsl(0,0%,19%)] flex flex-col items-center p-1
                  hover:scale-102 hover:cursor-pointer transition-all duration-100 ease-in">
              <div className="flex flex-col items-center justify-center flex-1">
                <CpuChipIcon className="h-16 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.7)] 
                transition-all duration-100 ease-in" />
              </div>
              <div className="w-3/4 flex-1 gap-2 flex flex-col">
                <h1 className="text-2xl font-bold self-center">
          ...
          <div className="suc">
            <div className="group h-full border-8 rounded-3xl border-[hsl(0,0%,19%)] flex flex-col items-center p-1
                  hover:scale-102 hover:cursor-pointer transition-all duration-100 ease-in">
              <div className="flex flex-col items-center justify-center flex-1">
                <DevicePhoneMobileIcon className="h-16 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.7)] 
                transition-all duration-100 ease-in" />
              </div>
              <div className="w-3/4 flex-1 gap-2 flex flex-col">
                <h1 className="text-2xl font-bold self-center">
          ...
          <div className="suc">
            <div className="group h-full border-8 rounded-3xl border-[hsl(0,0%,19%)] flex flex-col items-center p-1
                  hover:scale-102 hover:cursor-pointer transition-all duration-100 ease-in">
              <div className="flex flex-col items-center justify-center flex-1">
                <ServerStackIcon className="h-16 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.7)] 
                transition-all duration-100 ease-in" />
              </div>
              <div className="w-3/4 flex-1 gap-2 flex flex-col">
                <h1 className="text-2xl font-bold self-center">
